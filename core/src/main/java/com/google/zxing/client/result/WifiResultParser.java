 ...
 *
 * <p>{@code WIFI:T:WPA2-EAP;S:[network SSID];H:[hidden?];E:[EAP method];PH2:[Phase 2 method];AI:[anonymous identity];I:[username];P:[password];;}</p>
 *
...
public final class WifiResultParser extends ResultParser {
  ...
  public WifiParsedResult parse(Result result) {
    ...
    String anonymousIdentity = matchSinglePrefixedField(";AI:", rawText, ';', false);
